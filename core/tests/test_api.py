        ...
        self.assertEqual(j,
            {'@context': 'http://iiif.io/api/presentation/2/context.json',
             ...
             'manifests': [{'@id': 'https://oni.example.com/lccn/sn83030214/1898-01-01/ed-1.json',
                             '@type': 'sc:Manifest',
                             'label': '1898-01-01'}],
             'metadata': [{'label': 'county',
                            'value': [{'@value': 'Brooklyn'}, {'@value': 'Queens'}]},
        ...
        self.assertEqual(j,
            {'@context': 'http://iiif.io/api/presentation/2/context.json',
             ...
             'sequences': [{'@type': 'sc:Sequence',
                             'canvases': [{'@id': 'https://oni.example.com/images/tile/batch_curiv_ahwahnee_ver01%2Fdata%2Fsn83030214%2F00175037652%2F1898010101%2F0005.jp2',
                                            '@type': 'sc:Canvas',
                                            'height': 8677,
                                            'images': [{'@id': 'https://oni.example.com/images/tile/batch_curiv_ahwahnee_ver01%2Fdata%2Fsn83030214%2F00175037652%2F1898010101%2F0005.jp2',
                                                         '@type': 'oa:Annotation',
                                                         'motivation': 'sc:painting',
                                                         'on': 'https://oni.example.com/images/tile/batch_curiv_ahwahnee_ver01%2Fdata%2Fsn83030214%2F00175037652%2F1898010101%2F0005.jp2',
                                                         'rendering': [{'@id': 'https://oni.example.com/lccn/sn83030214/1898-01-01/ed-1/seq-1.pdf',
                                                                        ...
                                                                        {'@id': 'https://oni.example.com/lccn/sn83030214/1898-01-01/ed-1/seq-1/',
                                                                         'format': 'text/html'}],
                                                         'resource': {'@id': 'https://oni.example.com/images/tile/batch_curiv_ahwahnee_ver01%2Fdata%2Fsn83030214%2F00175037652%2F1898010101%2F0005.jp2',
                                                                       '@type': 'dctypes:Image',
                                                                       'format': 'image/jpeg',
                                                                       'height': 8677,
                                                                       'service': {'@context': 'http://iiif.io/api/image/2/context.json',
                                                                                    '@id': 'https://oni.example.com/images/tile/batch_curiv_ahwahnee_ver01%2Fdata%2Fsn83030214%2F00175037652%2F1898010101%2F0005.jp2',
                                                                                    'profile': 'http://iiif.io/api/image/2/level0.json'},
                                                                       'width': 6394},
                                                         'seeAlso': [{'@id': 'https://oni.example.com/lccn/sn83030214/1898-01-01/ed-1/seq-1/ocr.xml',
                                                                       'format': 'text/xml'}]}],
                                            'label': '1',
                                            'thumbnail': 'https://oni.example.com/images/resize/batch_curiv_ahwahnee_ver01%2Fdata%2Fsn83030214%2F00175037652%2F1898010101%2F0005.jp2/full/240,/0/default.jpg',
                                            'width': 6394}],
                             'label': 'issue order'}]})
